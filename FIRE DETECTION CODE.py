...
def message():
    account_sid = "AC26ce8348486745e0e1d3e541d55087b2"
    auth_token = "8b63ae4c8cbe78e09652abd41558c007"
    client = Client(account_sid, auth_token)
    message = client.api.account.messages.create(
        to="+917903512085",
        from_="+12722073178",
        body="ALERT....there is a fire in the Building!!")
...
filename = "/home/pi/Downloads/L3.3gp"
